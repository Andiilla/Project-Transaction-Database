...
#data cabang
cabang <- read.csv("D:/KULIAH S2 IPB/SEMESTER 2/MANAJEMEN DATA STATISTIKA/Project MDS/Project-Transaction-Database/Data/data_cabang.csv", stringsAsFactors = FALSE)
head(cabang)  # Cek apakah data terbaca dengan benar

#data invoice
invoice <- read.csv("D:/KULIAH S2 IPB/SEMESTER 2/MANAJEMEN DATA STATISTIKA/Project MDS/Project-Transaction-Database/Data/data_invoice.csv", stringsAsFactors = FALSE)
head(invoice)  # Cek apakah data terbaca dengan benar

#data pelanggan
pelanggan <- read.csv("D:/KULIAH S2 IPB/SEMESTER 2/MANAJEMEN DATA STATISTIKA/Project MDS/Project-Transaction-Database/Data/data_pelanggan.csv", stringsAsFactors = FALSE)
head(pelanggan)  # Cek apakah data terbaca dengan benar

#data produk
produk<- read.csv("D:/KULIAH S2 IPB/SEMESTER 2/MANAJEMEN DATA STATISTIKA/Project MDS/Project-Transaction-Database/Data/data_produk.csv", stringsAsFactors = FALSE)
head(produk)

#data stock
stock <- read.csv("D:/KULIAH S2 IPB/SEMESTER 2/MANAJEMEN DATA STATISTIKA/Project MDS/Project-Transaction-Database/Data/data_stock.csv", stringsAsFactors = FALSE)
