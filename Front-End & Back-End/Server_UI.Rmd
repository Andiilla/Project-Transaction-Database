...
ui <- dashboardPage(
  ...
  dashboardSidebar(
    sidebarMenu(
      ...
      menuItem("Kategori Produk", tabName = "analisis", icon = icon("chart-bar")),
      menuItem("Analisis Pola Pembelian", tabName = "analisis_pola_pembelian", icon = icon("shopping-cart")),
      menuItem("Stok Hampir Habis", tabName = "stok_hampir_habis", icon = icon("exclamation-triangle")),
      menuItem("Pendapatan Harian", tabName = "pendapatan_harian", icon = icon("chart-line")),
  ...
  dashboardBody(
    tabItems(
      ...
      tabItem(tabName = "analisis_pola_pembelian",
        fluidPage(
          titlePanel("Analisis Pola Pembelian Pelanggan"),
          # Tampilkan Tabel
          box(
            title = "Tabel Pola Pembelian", 
            status = "primary", 
            solidHeader = TRUE, 
            width = 12,
            dataTableOutput("pola_pembelian")
            ),
          # Tampilkan Visualisasi Grafik Batang
          box(
            title = "Grafik Pola Pembelian Pelanggan",
            status = "info",
            solidHeader = TRUE,
            width = 12,
      ...
      tabItem(tabName = "stok_hampir_habis",
        fluidPage(
          titlePanel("Stok Produk Hampir Habis (<50 unit)"),
          # Tampilkan Tabel
          box(
            title = "Tabel Stok Hampir Habis", 
            status = "danger", 
            solidHeader = TRUE, 
            width = 12,
            dataTableOutput("stok_hampir_habis")
          )
        )
      ),
      tabItem(tabName = "pendapatan_harian",
        fluidPage(
          titlePanel("Laporan Pendapatan Harian"),
          # Tampilkan Tabel Pendapatan Harian
          box(
            title = "Tabel Pendapatan Harian",
            status = "success",
            solidHeader = TRUE,
            width = 12,
            dataTableOutput("pendapatan_harian")
          ),
          # Tampilkan Grafik Tren Pendapatan Harian
          box(
