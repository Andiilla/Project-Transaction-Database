...
#data cabang
cabang <- read.csv("D://IPB//semester 2//Manajemen Data Statistika//Praktikum MDS//Project-Transaction-Database//Data//data_cabang.csv", stringsAsFactors = FALSE)
head(cabang)  # Cek apakah data terbaca dengan benar

<<<<<<< Updated upstream:DBManager/project UTS.Rmd
#data invoice
...
=======
#data produk
produk<- read.csv("D://IPB//semester 2//Manajemen Data Statistika//Praktikum MDS//Project-Transaction-Database//Data//data_produk.csv", stringsAsFactors = FALSE)
head(produk)
>>>>>>> Stashed changes:DBManager/UTS_PROJECT_MDS.Rmd

#data pelanggan
pelanggan <- read.csv("D://IPB//semester 2//Manajemen Data Statistika//Praktikum MDS//Project-Transaction-Database//Data//data_pelanggan.csv", stringsAsFactors = FALSE)
...
=======
#data invoice
invoice <- read.csv("D://IPB//semester 2//Manajemen Data Statistika//Praktikum MDS//Project-Transaction-Database//Data//data_invoice.csv", stringsAsFactors = FALSE)
head(invoice)  # Cek apakah data terbaca dengan benar
>>>>>>> Stashed changes:DBManager/UTS_PROJECT_MDS.Rmd

#data stock
stock <- read.csv("D://IPB//semester 2//Manajemen Data Statistika//Praktikum MDS//Project-Transaction-Database//Data//data_stock.csv", stringsAsFactors = FALSE)
